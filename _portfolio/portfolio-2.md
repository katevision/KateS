...
на протяжении всего анализа во мне боролись два желания: оставить как есть и все-таки приблизить данные к реальности искусственно (например, с помощью ИИ), чтобы было интересно с ними работать и все-таки я решила оставить как есть, проекты и отчеты могут быть разные.
